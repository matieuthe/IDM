 ...
 * </p>
 * <ul>
 *   <li>{@link csvManager.impl.ProgramImpl#getInstruction <em>Instruction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program {
	...
	protected EClass eStaticClass() {
		return CsvManagerPackage.Literals.PROGRAM;
	}
	...
	public EList<Instruction> getInstruction() {
		if (instruction == null) {
			instruction = new EObjectContainmentEList<Instruction>(Instruction.class, this,
					CsvManagerPackage.PROGRAM__INSTRUCTION);
		}
		return instruction;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CsvManagerPackage.PROGRAM__INSTRUCTION:

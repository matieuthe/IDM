 ...
 * </p>
 * <ul>
 *   <li>{@link csvManager.impl.WhereImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WhereImpl extends MinimalEObjectImpl.Container implements Where {
	...
	protected EClass eStaticClass() {
		return CsvManagerPackage.Literals.WHERE;
	}
	...
	public EList<Condition> getCondition() {
		if (condition == null) {
			condition = new EObjectContainmentEList<Condition>(Condition.class, this,
					CsvManagerPackage.WHERE__CONDITION);
		}
		return condition;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CsvManagerPackage.WHERE__CONDITION:

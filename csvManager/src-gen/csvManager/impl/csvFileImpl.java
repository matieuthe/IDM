 ...
 * </p>
 * <ul>
 *   <li>{@link csvManager.impl.CsvFileImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CsvFileImpl extends MinimalEObjectImpl.Container implements CsvFile {
	...
	protected EClass eStaticClass() {
		return CsvManagerPackage.Literals.CSV_FILE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CsvManagerPackage.CSV_FILE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CsvManagerPackage.CSV_FILE__NAME:
			return getName();
		}
